...
module VGA_COLOR(
    ...
    always @ (posedge shouldMove or posedge RST_BTN)
        if ( RST_BTN )
            ...
            begin
            dead = (((xMan > x1 - halfwidth - 5) && (xMan < x1 + width1 - halfwidth + 5)) || ((xMan > x2 - halfwidth - 5) && (xMan < x2 + width2 - halfwidth + 5)) || ((xMan > x3 - halfwidth - 5) && (xMan < x3 + width3 - halfwidth + 5))&&(yMan > 500)) ? 0 : 1;
